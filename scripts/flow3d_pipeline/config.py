...
MAIN_FIGURE_SCRIPTS = {
    ...
    "fig14": "paper_fig14_dynamics_residuals_by_state",
    ...
    "fig12": "paper_fig12_external_holdout_validation",
    "fig13": "paper_fig13_simulation_cross_sections",
}

SUPPLEMENTARY_FIGURE_STEMS = {
    "supp_figS1": "supp_figS1_all_boundary_fits",
    "supp_figS2": "supp_figS2_superellipsoid_parameters",
    "supp_figS3": "supp_figS4_dimensionless_sensitivity_grid",
    "supp_figS4": "supp_figS5_theory_identifiability_error_bounds",
    "supp_figS5": "supp_figS6_convex_alpha_proxy_comparison",
    "supp_figS6": "fig10_stability_attractor",
    "supp_figS7": "fig05_boundary_fit_comparison",
    "supp_figS8": "fig03_thermal_flow_evolution",
    "supp_figS9": "fig06_dynamics_model_comparison",
    "supp_figS10": "supp_figS10_temperature_dependent_properties",
}
